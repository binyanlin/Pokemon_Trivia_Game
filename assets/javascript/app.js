...
const displayer = function () {
  for (i = 0; i<selector.length; i++) {
    if (selector[i]) {
      $(".pokePic").html(`<img class="pokeImg" id="silhouette" src="https://pokeres.bastionbot.org/images/pokemon/${pokeNum[i]}.png"></img>`)
    }; 
  };
};
displayer();
