...
// pokemon full name list ordered (warning, 808 string long)
 ...
 const pokeListSpread = [kanto, johto, hoenn, sinnoh, unova, kalos, alola];
 const selectedGen = [false, false, false, false, false, false, false];
...
const gameEnd = function() {
  ...
  setTimeout(function() {
    ...
    $(".restart").html(`<div type="button" class="restartB"><img src="./assets/images/pokeball.png"></img>Restart</div>`);
  }, 1000 * 5);
};
